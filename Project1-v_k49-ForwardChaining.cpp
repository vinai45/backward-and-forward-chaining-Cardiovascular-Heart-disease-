...
//This class contains the implementation of Project1-AI-ForwardChaining.h

#include "Project1-v_k49-ForwardChaining.h"
using namespace std;

//Initializing the required methods
...
// Clause Variable List is stored in the file and then called here.
...
// Assigning the Clause number for the Clause variable list - uses MAP STL
...
// This function is used to compare two strings, in this program it compares DISEASE along with knowledge base.
...
void ForwardChaining::Treatment(string disease)
{
    ...
    if (disease != "")
    {
        while (!conc_var_queue.empty()) // Iterates until conclusion variable queue is not empty
        {
            ...
            // Finding the disease and comparing it with knowledge base
            ...
            {
                Clause_no = Clause_no + 2; // Going to the next position where disease is there in Clause variable list.
