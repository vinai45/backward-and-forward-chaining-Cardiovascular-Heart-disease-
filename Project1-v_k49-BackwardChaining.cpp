...
#include "Project1-v_k49-BackwardChaining.h"
...
//then knowledge base is created.
void BackwardChaining::knowledgebase()
{
    ...
    varibles_questions.insert({"RECG","What's the result of ECG? (VALVE_ABNORMALITIES/ABNORMAL/NORMAL)"});
    varibles_questions.insert({"STRESSTEST","what's the result of Stress test? (HIGH)"});
